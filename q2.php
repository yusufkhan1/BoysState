...
<?php
	...
	$query = "SELECT alumni_id,name_first,name_last,parent_city,date_last_modified FROM production_alumni_table ORDER BY name_last"; $users = mysql_query($query, $mysql_link);
